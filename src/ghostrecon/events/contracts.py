...
class EventName(StrEnum):
    ...
    CRM_TARGET_CREATED = "crm_target.created"
    CRM_EXPORT_BATCH_STARTED = "crm_export.batch_started"
    CRM_EXPORT_ITEM_SUCCEEDED = "crm_export.item_succeeded"
    CRM_EXPORT_ITEM_FAILED = "crm_export.item_failed"
    CRM_EXPORT_BATCH_COMPLETED = "crm_export.batch_completed"
    ...
    MEETING_PREP_PACKET_GENERATED = "meeting.prep_packet_generated"
    MEETING_OUTCOME_RECORDED = "meeting.outcome_recorded"
    MEETING_FOLLOW_UP_TASK_CREATED = "meeting.follow_up_task_created"
