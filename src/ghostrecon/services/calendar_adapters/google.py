...
class GoogleCalendarClient:
    ...
    def _jwt_assertion(self) -> str:
        ...
        if not isinstance(key, RSAPrivateKey):
            raise ValueError("Google Calendar credentials require an RSA private key")
...
from .base import CalendarEventRequest, CalendarEventResult, CalendarProviderError  # noqa: E402
